// ******************************* CONFIGURE PINS, SCREENS, ROTATION, WIFI ETC HERE. *******************************
...
const char *ota_hostname = "max7219"; // OTA Hostname

const char *mqtt_name = "matrix_clock";
const char *mqtt_server = "SERVER_DOMAIN_OR_IP";
